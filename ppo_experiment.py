...
def main(kwargs: dict):
    ...
    ppo_configs = {
        ...
        'batch_size': min(number_of_cpu, kwargs['batch_size']),
        'n_epochs': number_of_cpu,
...
if __name__ == "__main__":
    print(f"Starting experiment with PPO at {dt.now()}")
